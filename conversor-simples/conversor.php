...
<body>
    <div class="form-container d-flex flex-column justify-content-center align-items-center rounded">
        <h3>Concersor de moedas(brl=>usd)</h3>
        <form class="generator col-12" action="result.php" method="get">
            <div class="mb-3">
                <label for="valor" class="form-label">Valor:</label>
                <input type="number" step=".01" class="form-control" id="valor" name="valor" value="0">
            </div>
